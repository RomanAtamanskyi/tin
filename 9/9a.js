...
const Calc = function (num) {this.num = num;};
...
const results = (function () {
    let results = [];
    return {
        add: function (obj) {results.push(obj);},
...
Calc.prototype = {
    ...
    subtract: function (n) {
        let result = Math.floor(this.num - n);
        results.add({num1: this.num,num2: n,operation: "subtract",res: result});
        this.num = result;
        return this;
    },
    multiply: function (n) {
        let result = (this.num * n);
        results.add({num1: this.num,num2: n,operation: "multiply",res: result});
        this.num = result;
        return this;
    },
    divide: function (n) {
...
main.post("/calculator", (req, res) => {
    ...
    switch (func) {
        case "add": request.add(num2);break;
        case "sub":request.subtract(num2);break;
        case "mul":request.multiply(num2);break;
        case "div":request.divide(num2);break;
        default:results.clear();break;
    }
